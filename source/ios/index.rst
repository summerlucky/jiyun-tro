...
1、因最近苹果风控升级，共享账号平均3-7天就会封一个号，且shadowrocket是2.99美金的收费软件，目前暂时不给提供共享账号，请用自己的独立美区id更新和下载shadowrocket

2、可联系客服购买独立账号，25元一个（不带收费软件，不带shadowrocket），50元一个独立账号（带shadowrocket），10元一次共享账号（带shadowrocket），或者自行谷歌搜关键词苹果美区id去别家买，因产品特殊及苹果风控原因，不售后
...
设置方式二：手动设置（如果通过订阅的方式设置失败，更新后无法显示服务器，再用此方法手动设置，否则一般不用再手动设置）

.. image::  /images/ios-5.jpg

.. image::  /images/ios-6.jpg

设置完毕后点完成，返回首页连接即可，弹出提示请选择允许
